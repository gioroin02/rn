...
typedef PxMap(PxStr8, u32) PxMapString8U32;
...
void
showPairs(PxMapString8U32* self, PxStr8* keys, ssize size)
{
    ssize index = 0;
...
void
showLists(PxMapString8U32* self)
{
    ssize index = 0;
...
main(int argc, char** argv)
{
    ...
    showPairs(&map, keys, sizeof keys);
    showLists(&map);
