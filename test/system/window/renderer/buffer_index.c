#ifndef P_GRAPHICS_BUFFER_INDEX_C
#define P_GRAPHICS_BUFFER_INDEX_C
...
Bool pBufferIndexCreate(PBufferIndex* self, Int count, Int size)
{
    ...
    glBufferData(GL_ELEMENT_ARRAY_BUFFER, bytes,
...
Int pBufferIndexWrite(PBufferIndex* self, U8* pntr, Int start, Int stop)
{
    ...
    glBufferSubData(GL_ELEMENT_ARRAY_BUFFER, start, stop - start, pntr);
...
#endif // P_GRAPHICS_BUFFER_INDEX_C
