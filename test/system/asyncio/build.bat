...
set "impl=%base% %base_memory% %system_memory% %system_network% %system_asyncio%"

set "test_server_tcp=test\system\asyncio\server-tcp.c"
set "test_client_tcp=test\system\asyncio\client-tcp.c"

%compiler% --std=c99 %impl% %test_server_tcp% -lws2_32 -o bin\system_asyncio_server_tcp.exe
%compiler% --std=c99 %impl% %test_client_tcp% -lws2_32 -o bin\system_asyncio_client_tcp.exe
