...
$compiler --std=c99 $impl $test_address_ip -o bin/system_network_address_ip.exe
$compiler --std=c99 $impl $test_server_udp -o bin/system_network_server_udp.exe
$compiler --std=c99 $impl $test_client_udp -o bin/system_network_client_udp.exe
$compiler --std=c99 $impl $test_server_tcp -o bin/system_network_server_tcp.exe
$compiler --std=c99 $impl $test_client_tcp -o bin/system_network_client_tcp.exe
